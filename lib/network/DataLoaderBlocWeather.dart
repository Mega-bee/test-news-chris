...
class DataLoaderBlocWeather extends Bloc<GlobalEvent, GlobalState> {
  DataLoaderBlocWeather(initialState) : super(initialState);
    ...
    if (event is FetchData) {
      ...
      try {
        ...
        if (response != null) {
          ...
          WeatherServiceResponse? webServiceResponse;
          try {

            webServiceResponse =
                WeatherServiceResponse.fromJson(json.decode(response.body));
